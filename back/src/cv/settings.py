...
TEMPLATES = [
    {
        ...
        # back/src/templates + back/templates
        'DIRS': [
            BASE_DIR / 'templates',
...
STATIC_URL = '/static/'
# Serve static files from both back/src/static and project-level back/static
STATICFILES_DIRS = [
    #BASE_DIR / "static",
...
# deployment and for storage backends that require a filesystem path.
